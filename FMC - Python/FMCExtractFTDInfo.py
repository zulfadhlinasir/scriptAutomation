...
try:
    ...
    # r = requests.post(auth_url, headers=headers, auth=requests.auth.HTTPBasicAuth(username,password), verify=r"C:\Users\xxxx\Desktop\SSL Cert\FMCRootCe.cer")
...
try:
    ...
    # r = requests.get(url, headers=headers, verify=r'C:\Users\xxxxxx\Desktop\SSL Cert\FMCRootCe.cer')
